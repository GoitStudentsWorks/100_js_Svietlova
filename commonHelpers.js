import{S as p,N as b,K as _,M as j,A as h,P as y,i as S}from"./assets/vendor-a432d4a5.js";(function(){const s=document.createElement("link").relList;if(s&&s.supports&&s.supports("modulepreload"))return;for(const e of document.querySelectorAll('link[rel="modulepreload"]'))r(e);new MutationObserver(e=>{for(const o of e)if(o.type==="childList")for(const n of o.addedNodes)n.tagName==="LINK"&&n.rel==="modulepreload"&&r(n)}).observe(document,{childList:!0,subtree:!0});function i(e){const o={};return e.integrity&&(o.integrity=e.integrity),e.referrerPolicy&&(o.referrerPolicy=e.referrerPolicy),e.crossOrigin==="use-credentials"?o.credentials="include":e.crossOrigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function r(e){if(e.ep)return;e.ep=!0;const o=i(e);fetch(e.href,o)}})();(()=>{const t=document.querySelector(".js-menu-container"),s=document.querySelector(".js-open-menu"),i=document.querySelector(".js-close-menu"),r=document.querySelector(".mobile-menu"),e=document.querySelector(".header-order-link"),o=()=>{const n=s.getAttribute("aria-expanded")==="true"||!1;s.setAttribute("aria-expanded",!n),t.classList.toggle("is-open")};s.addEventListener("click",o),i.addEventListener("click",o),r.addEventListener("click",o),e.addEventListener("click",o),window.matchMedia("(min-width: 768px)").addEventListener("change",n=>{n.matches&&(t.classList.remove("is-open"),s.setAttribute("aria-expanded",!1))})})();const L=document.querySelector(".menu-title");L.addEventListener("click",t=>{t.preventDefault(),document.querySelector(".header-list").classList.toggle("hidden")});const x=document.querySelectorAll(".accordion-header"),q=document.querySelector(".accordion-panel"),A=document.querySelector(".about-ac"),P=document.querySelector(".mobile-open-ac");q.style.maxHeight="100%";A.classList.add("active");P.style.transform="rotate(180deg)";x.forEach(t=>{t.addEventListener("click",function(){const s=this.closest(".about-ac"),i=s.querySelector(".accordion-panel"),r=this.querySelector(".mobile-open-ac");s.classList.toggle("active"),s.classList.contains("active")?(i.style.maxHeight=i.scrollHeight+"px",r.style.transform="rotate(180deg)"):(i.style.maxHeight="0",r.style.transform="rotate(0deg)")})});new p(".about-swiper-container",{loop:!0,setWrapperSize:!0,modules:[b,_,j],spaceBetween:0,simulateTouch:!0,grabCursor:!0,slideActiveClass:"active",navigation:{nextEl:".about-swiper-button"},keyboard:{enabled:!0,onlyInViewport:!1},breakpoints:{320:{slidesPerView:2},375:{slidesPerView:2},768:{slidesPerView:3},1440:{slidesPerView:6}}});const E="/100_js_Svietlova/assets/image1.11px-bb988309.png",k="/100_js_Svietlova/assets/image1.12px-111ca135.png",m="/100_js_Svietlova/assets/image1.21px-daf377c0.png",B="/100_js_Svietlova/assets/image1.22px-6e1e77a8.png",$="/100_js_Svietlova/assets/image2.11px-9880dbfd.png",M="/100_js_Svietlova/assets/image2.12px-0ceb49a4.png",g="/100_js_Svietlova/assets/image2.21px-eb6c78ab.png",I="/100_js_Svietlova/assets/image2.22px-1fb0ec3f.png",T="/100_js_Svietlova/assets/image3.11px-82c7ad1f.png",O="/100_js_Svietlova/assets/image3.12px-6322b368.png",v="/100_js_Svietlova/assets/image3.21px-356430ed.png",V="/100_js_Svietlova/assets/image3.22px-e3ae8908.png",z=document.querySelector(".projects_slider_btn--right"),H=document.querySelector(".projects_slider_btn--left"),w=new p(".projects_box",{speed:400,spaceBetween:100});H.addEventListener("click",()=>{K(),w.slidePrev()});z.addEventListener("click",()=>{R(),w.slideNext()});const N=document.querySelector(".projects_wrapper"),C=`
